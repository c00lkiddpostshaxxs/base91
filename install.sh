...
curl -fsSL 'https://raw.githubusercontent.com/c00lkiddpostshaxxs/base91/main/base91.c' -o base91.c || { echo "Error: Failed to download base91.c! Check your GitHub URL."; exit 1; }
